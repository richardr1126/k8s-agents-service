...
const components: Components = {
  ...
  code: ({ className, ...props }) => {
    ...
    return (
      <code
        className={cn(
          isInline && "bg-muted rounded border px-1 py-0.5 font-semibold",
          className,
        )}
        {...props}
      />
...
const MarkdownStringImpl = ({ children }: { children: string }) => (
...
export const MarkdownString = memo(MarkdownStringImpl);
